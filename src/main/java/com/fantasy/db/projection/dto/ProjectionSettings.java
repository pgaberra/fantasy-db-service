...
public record ProjectionSettings(
        ...
        @Schema(description = "What the player rows started from, and so what a player who joins the pool later is seeded with: last season's stat line, zeros, or the projection model's line. Absent on projections saved before this was recorded.")
